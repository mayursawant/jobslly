...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://healthcare-board.preview.emergentagent.com"  # Production
    ],
...
# 6. Test in browser
# Visit: https://healthcare-board.preview.emergentagent.com
```
...
curl -I https://healthcare-board.preview.emergentagent.com
# Expected: HTTP/2 200
    ...
    spec:
      ...
      - name: frontend
        ...
        - name: REACT_APP_BACKEND_URL
          value: "https://healthcare-board.preview.emergentagent.com"
        resources:
          requests:
            memory: "128Mi"
            cpu: "100m"
