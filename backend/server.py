...
async def get_sitemap():
    ...
    base_url = os.environ.get('FRONTEND_URL', 'https://jobslly-redesign.preview.emergentagent.com')
        ...
        if page_type == "job" and job_id:
            ...
            if job:
                return {
                    ...
                    "og_image": f"https://jobslly-redesign.preview.emergentagent.com/api/og-image/job/{job_id}",
                    "canonical": f"https://jobslly-redesign.preview.emergentagent.com/jobs/{job_id}"
                }
            ...
            if post:
                return {
                    ...
                    "og_image": post.get('featured_image') or f"https://jobslly-redesign.preview.emergentagent.com/api/og-image/blog/{blog_slug}",
                    "canonical": f"https://jobslly-redesign.preview.emergentagent.com/blog/{blog_slug}"
                }
