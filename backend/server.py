...
async def get_seo_meta(page_type: str, job_id: str = None, blog_slug: str = None):
        ...
        if page_type == "job" and job_id:
            ...
            if job:
                return {
                    ...
                    "og_image": f"https://career-site-revamp.preview.emergentagent.com/api/og-image/job/{job_id}",
                    "canonical": f"https://career-site-revamp.preview.emergentagent.com/jobs/{job_id}"
                }
            ...
            if post:
                return {
                    ...
                    "og_image": post.get('featured_image') or f"https://career-site-revamp.preview.emergentagent.com/api/og-image/blog/{blog_slug}",
                    "canonical": f"https://career-site-revamp.preview.emergentagent.com/blog/{blog_slug}"
                }
    ...
    return {
        ...
        "og_image": "https://career-site-revamp.preview.emergentagent.com/og-image-default.jpg",
        "canonical": "https://career-site-revamp.preview.emergentagent.com"
    }
...
logging.info("[STARTUP] Adding MetaTagInjectionMiddleware...")
app.add_middleware(MetaTagInjectionMiddleware)
logging.info("[STARTUP] Middleware added successfully")
